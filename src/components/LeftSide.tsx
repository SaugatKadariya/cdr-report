...
const LeftSide = ({ amount, setAmount }: { amount: string, setAmount: (val: string) => void }) => {
  ...
  return (
   <div className="xl:w-1/2 bg-[#4B1FB8] pt-12 xl:pl-[72px] px-8 flex xl:items-start xl:polygon overflow-hidden items-center xl:h-full h-[400px] xl:justify-start justify-center">
